...
php vendors/image_inline/inject_images.php ./output/content_inline.html ./output/content_ready.html
php vendors/cleanup/cleanup.php ./output/content_ready.html ./output/content_ready.html
